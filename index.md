...
venue: "Queensland University of Technology, Kelvin Grove campus"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Seminar room Q430, IHBI, 60 Musk Avenue, Kelvin Grove"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latitude: "-27.452780"     # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "153.013966"    # decimal longitude of the workshop venue (use https://www.latlong.net)
...
eventbrite: "94781944347"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
